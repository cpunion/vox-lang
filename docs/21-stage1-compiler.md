...
3. 类型反射 intrinsic：已支持 `@size_of/@align_of/@type_name/@field_count/@field_name/@field_type` 以及 `@is_integer/@is_float/@is_struct/@is_enum`，并在 const 与 IR lowering 阶段常量折叠。
