...
This folder contains compiler-oriented design and implementation notes.

Core docs:

- `docs/internal/00-overview.md`
- `docs/internal/01-type-system.md`
- `docs/internal/02-error-handling.md`
- `docs/internal/03-module-package.md`
- `docs/internal/04-generics-comptime.md`
- `docs/internal/05-comptime-detailed.md`
- `docs/internal/06-advanced-generics.md`
- `docs/internal/07-memory-management.md`
- `docs/internal/08-thread-safety.md`
- `docs/internal/09-async-model.md`
- `docs/internal/10-macro-system.md`
- `docs/internal/11-package-management.md`
- `docs/internal/12-testing-framework.md`
- `docs/internal/13-standard-library.md`
- `docs/internal/14-syntax-details.md`
- `docs/internal/15-toolchain.md`
- `docs/internal/16-platform-support.md`
- `docs/internal/17-ffi-interop.md`
- `docs/internal/18-diagnostics.md`
- `docs/internal/19-ir-spec.md`
- `docs/internal/20-bootstrap.md`
- `docs/internal/24-release-process.md`
