...
// keywords
fn let mut return if else true false type const static import pub match as while break continue
// punct/op
(){}[] , ; : :: . + - * / % ! = == != < <= > >= && || ->
// string
"a\nb\t\"c\"\\"
`)
	...
	wantPrefix := []Kind{
		...
		TokenPub, TokenMatch, TokenAs, TokenWhile, TokenBreak, TokenContinue,
	}
